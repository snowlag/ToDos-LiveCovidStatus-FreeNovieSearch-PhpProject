	...
	<div class="container">
      ...
      <div class="panel-heading"><h3><center><b>Login</b></center></h3></div>
       ...
       <form method="post" ">
          ...
          <div class="form-group">
            <center>
                <button type="button" id="loginbutton" class="btn btn-success btn-lg" name="register" value="register">Login</button>
            </center>
          </div>
             <div id="result"> </div>
        </form>
        <center><a href="../Registration/register.php">Not Registered? Sign in</a></center>
